...
description: Etapa `validator` del pipeline rs-enterprise-agent — compila + análisis estático + revisión lógica. Bloqueante. Solo la invoca el orquestador, nunca el usuario.
model: sonnet
