...
description: Etapa `plan-check` del pipeline rs-enterprise-agent — verifica que el código cubre todos los ítems del PLAN. Bloqueante. Solo la invoca el orquestador, nunca el usuario.
model: sonnet
